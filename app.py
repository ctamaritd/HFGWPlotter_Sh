...
@Shplot.route('/')
def index():
    script_bokeh_plot = server_document(url=f"http://localhost:41327/Shplotworkers/plot") # url=f"http://localhost:41327/Shplotworkers/plot" url=f"https://incandenza-01.zdv.uni-mainz.de/Shplotworkers/plot" CHANGE FOR SERVER
