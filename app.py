...
def bokeh_plot_app(doc):
    ...
    #Logo source object
    logo_source = ColumnDataSource(dict(url=["/Shplot/static/logo.png"], x=[6.e10], y=[5e-26]))
    ...
    def update_frange(new, curves_dict):
        ...
        logo_source.data['x'] = [10**(new[1]-(new[1]-new[0])/49.5833)]
    ...
    def update_Shrange(new, curves_dict):
        ...
        logo_source.data['y'] = [10**(new[0]+(new[1]-new[0])/45.0758)]
