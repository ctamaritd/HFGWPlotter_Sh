...
detector_data = [
    ...
    ('Curves/DetectorCurves/IAXOHET_LOW.txt', 'LF IAXO-HET', 'Proposed', 'Curves', color_proposed, 2, 'solid', 1,'glyph', None, 6e9, 8e-24,- np.pi/4, color_proposed, '11pt' ),
    ...
    #GW INTERFEROMETERS
    ('Curves/DetectorCurves/ligoO4a_simple.csv', 'LIGO', 'Existing', 'Areas', color_current, 2, 'solid', 0.5, 'underlay', None, 3E1, 1e-17, np.pi/2, 'white', '10pt' ),
    ...
    #Madmax
     ...
     #Holometer
     ('Curves/DetectorCurves/HOLOMETER.txt', 'Holometer', 'Existing', 'Areas', color_current, 2, 'solid', 0.5,'underlay', None, 2E6, 1E-19, np.pi/2, 'white', '11pt' ),
     #Levitated sensors
     ...
     ('Curves/DetectorCurves/SLedDoG_30kg.csv', 'Lev. SC 30kg', 'Proposed', 'Curves', color_proposed, 2, 'solid', 1,'overlay', None,1E2, 1.1E-18, -np.pi/2.8, color_proposed, '11pt' )
]
