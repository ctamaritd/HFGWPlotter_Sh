...
detector_data = [
    ...
    #Magnetic Weber bars
    ('Curves/DetectorCurves/MWB-DMR-broad.csv', 'Mag. Weber bars', 'Proposed', 'Curves', color_proposed, 2, 'solid', 1,'glyph', None, 7E1,  1.7e-1*1.086552572360649e-19, -3.6*np.pi/8, color_proposed, '11pt' ),
    ...
    #HELIOSCOPES
    ('Curves/DetectorCurves/IAXOHET.txt', 'LF IAXO-HET', 'Proposed', 'Curves', color_proposed, 2, 'dashed', 1,'glyph', None, 1E11, 1.5E-25, -np.pi/3.9, color_proposed, '11pt' ),
    ...
    ('Curves/DetectorCurves/IAXOSPD.txt', 'LF IAXO-SPD', 'Proposed', 'Curves', color_proposed, 2, 'dashed', 1,'glyph', None, 1.E11, 8E-32, -np.pi/4, color_proposed, '11pt' ),
    ...
    ('Curves/DetectorCurves/CAST.txt', 'CAST', 'Existing', 'Areas', color_current, 2, 'solid', 0.5,'underlay', None, 9E17,  4.E-37, np.pi/2, 'white', '11pt' ),
    #GW INTERFEROMETERS
    ('Curves/DetectorCurves/ligoO4a_simple.csv', 'LIGO', 'Existing', 'Areas', color_current, 2, 'solid', 0.4, 'underlay', None, 3E1, 1e-17, np.pi/2, 'maroon', '10pt' ),
    ...
    ('Curves/DetectorCurves/ALPSII.txt', 'ALPS II', 'Ongoing', 'Curves', color_ongoing, 2, 'solid', 1, 'underlay', None, 3E14, 9E-37, -np.pi/4, color_ongoing, '11pt' ),
    ('Curves/DetectorCurves/ALPSIIRes.txt', 'ALPS II res', 'Ongoing', 'SingleFreq', color_ongoing, 3, 'dotted', 1, 'underlay', None,  3E14, 8.E-39, -np.pi/4, color_ongoing, '11pt' ),
    ('Curves/DetectorCurves/JURA.txt', 'JURA', 'Proposed', 'Curves', color_proposed, 2, 'solid', 1, 'underlay', None, 3E14, 1.5E-37, -np.pi/4, color_proposed, '11pt' ),
    ('Curves/DetectorCurves/OSQAR.txt', 'OSQAR II', 'Existing', 'Areas', color_current, 2, 'solid', 0.5, 'underlay', None, 5.5E14,    3.5E-33, np.pi/2, 'white', '11pt' ),
    #Madmax
     ('Curves/DetectorCurves/madmax_hybrid_broad_ext.csv', 'Madmax', 'Ongoing', 'Curves', color_ongoing_4, 2, 'solid', 1,'glyph', None, 1.3e11, 4E-23, 0., color_ongoing_4, '11pt' ),
     ...
     #Holometer
     ('Curves/DetectorCurves/HOLOMETER.txt', 'Holometer', 'Existing', 'Areas', color_current, 2, 'solid', 0.4,'underlay', None, 2E6, 1E-19, np.pi/2, 'maroon', '11pt' ),
     #Levitated sensors
     ('Curves/DetectorCurves/levitatedSensors_1mdisc.csv', 'Lev. sens. 1m', 'Ongoing', 'Curves', color_ongoing, 3, 'dotted', 1,'glyph', None, 1E4, 5E-19, -np.pi/2.81, color_ongoing, '11pt' ),
     ('Curves/DetectorCurves/levitatedSensors_100m.csv', 'Lev. sens. 100m', 'Proposed', 'Curves', color_proposed, 3, 'dotted', 1,'glyph', None, 6e4, 8e-24, -np.pi/25, color_proposed, '11pt' ),
     #Bulk accoustic wave devices
     ('Curves/DetectorCurves/BAW_current.txt', 'BAW 1', 'Existing', 'SingleFreq', color_current, 2, 'solid', 1,'glyph', None, 4.5e6, 1.5e-21, np.pi/2, color_current, '11pt' ),
     ...
     ('Curves/DetectorCurves/SLedDoG1g.csv', 'Lev. SC 1g', 'Proposed', 'Curves', color_proposed, 2, 'solid', 1,'glyph', None, 1E3, 1.6E-16, -np.pi/2.8, color_proposed, '11pt' ),
     ('Curves/DetectorCurves/SLedDoG_30kg.csv', 'Lev. SC 30kg', 'Proposed', 'Curves', color_proposed, 2, 'solid', 1,'glyph', None,1E2, 1.1E-18, -np.pi/2.8, color_proposed, '11pt' )
]
