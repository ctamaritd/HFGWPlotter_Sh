...
detector_data = [
    ...
    ('Curves/DetectorCurves/ligoO4a.csv', 'LIGO', 'Existing', 'Areas', color_current, 2, 'solid', 0.6, 'underlay', None, 1.8e3, 2.7e-24, 0.9*np.pi/4, color_current, '11pt' ),
    ...
    ('Curves/DetectorCurves/LIGOHF2.txt', 'LIGO HF', 'Proposed', 'Curves', color_proposed, 2, 'solid', 1,'glyph', None, 2E5,  3.5E-22, 0.7*np.pi/2.8, color_proposed, '11pt' ),
    ...
    ('Curves/DetectorCurves/GEOHF.txt', 'GEO HF', 'Proposed', 'Curves', color_proposed, 2, 'solid', 1, 'underlay', None, 2E5,  3.5E-21, 0.7*np.pi/2.8, color_proposed, '11pt' ),
    ('Curves/DetectorCurves/nemo.csv', 'NEMO', 'Ongoing', 'Curves', color_ongoing, 2, 'solid', 1, 'underlay', None, 6e3, 1.5E-24, 2.9*np.pi/8, color_ongoing, '11pt' ),
    ('Curves/DetectorCurves/QUEST.csv', 'QUEST', 'Existing', 'Areas', color_current, 2, 'solid', 0.6, 'underlay', None, 2E7, 4E-18, 0., 'white', '11pt' ),
    ...
    ('Curves/DetectorCurves/ALPSIIRes.txt', 'ALPS II res', 'Ongoing', 'SingleFreq', color_ongoing, 2, 'solid', 1, 'glyph', None, None, None, np.pi/2, color_ongoing, '11pt' ),
    ...
    #Madmax
     ...
     #Holometer
     ('Curves/DetectorCurves/HOLOMETER.txt', 'Holometer', 'Existing', 'Areas', color_current, 2, 'solid', 0.6,'underlay', None, 2E6, 1.E-18, np.pi/2, 'white', '11pt' ),
     #Levitated sensors
